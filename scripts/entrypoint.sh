...
DB_FILE=$(python3 -c "import json; print(json.load(open('$MANIFEST')).get('database','').replace('\\\\','/'))")
LICENSE_FILE=$(python3 -c "import json; print(json.load(open('$MANIFEST')).get('licenseFile','').replace('\\\\','/'))")
